...
const Orders = () => {
    ...
    return (
        <div id='orders' className='flex items-center flex-col lgl:flex-row justify-around h-[185vh] lgl:h-[100vh] bg-black text-white'>
            ...
            <div className='flex w-[100%] flex-1 flex-col items-center justify-center bg-[#DF080F] h-full text-white gap-8'>
                ...
                <p className='w-[60%] text-center font-poppines2'>To help us find the best table for you, select the preferred party size, date, and time of your reservation.</p>
                <form action="" className='flex flex-col justify-center w-[60%]'>
                    <div className='flex justify-center relative flex-col'>
                        ...
                        <select
                            ...
                            className='my-2 text-white w-[100%] mb-6 px-4 py-[10px] border border-white outline-none rounded-3xl cursor-pointer bg-transparent'
                        >
